...
void DefaultSceneLayer::_CreateScene()
{
	...
	if (loadScene && std::filesystem::exists("scene.json")) {
		...
		Texture3D::Sptr lut = ResourceManager::CreateAsset<Texture3D>("luts/lut1.CUBE");
		//Texture3D::Sptr lut = ResourceManager::CreateAsset<Texture3D>("luts/lut2.CUBE");
		//Texture3D::Sptr lut = ResourceManager::CreateAsset<Texture3D>("luts/lut3.CUBE");
